...
<br />
<br />
<a class="btn-success btn" href='http://<?php echo $_SERVER['HTTP_HOST'];?>' target="_blank">Перейти на сайт</a>
<br />
<br />
<br />
<form method="post">
...
if($action = $_POST['del']){
	if(unlink($_SERVER['DOCUMENT_ROOT'].'/mirror.php')){
		...
		echo '<br><br><p style="font-size: 20px; color: green">File mirrors.php deleted</p>';?>
		<body onLoad="tiktak();">
            <div>
