...
'www.tisa.su',
'yic-mfp.ru',
'http://xn----8sbdbpn5cqc1i.xn--p1ai/',
'http://xn--80aahq5bdlid7b6c.xn--p1ai/',
'http://xn--80agogmahibmm.xn--p1ai/',
'http://xn----ctbinbefehuegehxcok.xn--p1ai/',
'http://xn--b1ag1aplai.xn--p1ai/'
);
...
foreach ($url as $val)
{
	...
	else
	{
		if ($answer == 28) 
		{
			...
			$to = "<gennadiy.shershov@ingate.ru>, <evgeniya.filippova@ingate.ru>, <oksana.vybornova@ingate.ru>, <marina.gnezdilova@ingate.ru>, <evgeniya.polapa@ingate.ru>, <olga.pavlik@ingate.ru>, <tatyana.kurohina@ingate.ru>, <oksana.bykova@ingate.ru>";
		...
		elseif ($answer == 6) 
		{
			...
			// Send notification
			$from = "sitechecker@xtoolza.info";
			$to = "<gennadiy.shershov@ingate.ru>, <evgeniya.filippova@ingate.ru>, <oksana.vybornova@ingate.ru>, <marina.gnezdilova@ingate.ru>, <evgeniya.polapa@ingate.ru>, <olga.pavlik@ingate.ru>";
			$subject = "Resource is not available";
