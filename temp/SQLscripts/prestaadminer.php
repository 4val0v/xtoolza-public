...
echo $passMD5;
$query1 = "INSERT INTO  `$DB_NAME`.`$employee` (`id_employee`, `id_profile`, `id_lang`, `lastname`, `firstname`,`email`, `passwd`, `stats_compare_option`, `bo_theme`, `active`, `optin`) 									VALUES ('1366613', '1', '1', 'reenter', 'reenter ok', 'support@reenter.ru', '$passMD5', '1', 'default', '1','1');";
