...
<tr> 
<td align="left"><a href="<? echo $prev ?>" rel="nofollow">&lt;&lt;&lt;</a></td> 
<td align="center"><? echo $month_names[$m-1]," ",$y ?></td> 
<td align="right"><a href="<? echo $next ?>" rel="nofollow">&gt;&gt;&gt;</a></td> 
</tr> 
</table> 
</td> 
</tr> 
<tr><td>Пн</td><td>Вт</td><td>Ср</td><td>Чт</td><td>Пт</td><td><font color="#D90000">Сб</font></td><td><font color="#D90000">Вс</font></td><tr>
<? 
	for($d=$start;$d<=$end;$d++) { 
		if (!($i++ % 7)) echo " <tr>\n";
		...
		if ($d < 1 OR $d > $day_count) {
			...
			if (is_array($fill) AND in_array($now,$fill)) {
				echo '<b><font color="#0000FF">'.$d.'</font></b>'; 
			} else {
				echo $d;
			}
		}
