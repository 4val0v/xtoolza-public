...
<html>
<head>
	<title>Пакетная проверка наличия колтрекинга на сайтах</title>
			...
			<tr>
				...
				<td>
					<table>
						<tbody>
							<tr>
								<td><h1 class="jumbotron">Пакетная проверка наличия колтрекинга на сайтах</h1></td>
							</tr>
							<tr>
...
<div style="width: 750px font-size:14px;">Данный инструмент позволяет проверить список страниц на наличие на них колтрекинга
</div><br>
