...
if ($_POST['textt'] != ''){
	echo "<table cellpadding=\"5\"><tr><td><img src=\"http://xtoolza.info/q/images/punypuny.jpg\" width=\"90\"></td><td><h1>Пакетный конвертер URLEncode/URLDecode:</h1></td></tr></table>";
	}
else die('Поле должно быть заполнено!');  

//вывод в таблицу	
echo "<table border=\"1\" bordercolor=\"#CDC9C9\"><tr><td><b>URL</b></td><td><b>Encoded</b></td></tr>"; 
$plist = explode("\r\n",$_POST['textt']); 

function result($plist)  {
	foreach ($plist as $arraylist) {
		$newarraylist = htmlentities(urlencode($arraylist));
