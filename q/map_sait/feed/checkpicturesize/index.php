...
<html>
<head>
	<title>Пакетная проверка размеров файлов изображений из фида YML</title>
	<meta charset="UTF-8" />
			...
			<tr>
				...
				<td>
					<table>
						<tbody>
							<tr>
								<td><h1 class="jumbotron">Пакетная проверка размеров файлов изображений из фида YML</h1></td>
							</tr>
							<tr>
								<td><img src="http://reentermanual.local/q/images/statuscode.png" width="80" alt="Пакетная проверка размеров файлов изображений из фида YML"></td>
							</tr>
						</tbody>
					</table>
				</td>
...
<table id="tablespecial">
	<tr>
		<td style="vertical-align:top;">
			<form id='context' method='post'>Рандомные 200 URL:<br><br>
			<?
				$PCREpattern = '/\r\n|\r|\n/u';
				function offers(){
						$counstr=200;
						$file=file('/var/www/feed/logs/feedpictureavailable.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
						shuffle($file);
						for($i=0;$i<$counstr;$i++){
