...
<html>
<head>
	<title>Пакетная проверка даты фида</title>
	<meta name="description" content="Пакетная проверка даты фида" />
	<meta name="keywords" content="Пакетная проверка даты фида">
			...
			<tr>
				...
				<td>
					<table>
						<tbody>
							<tr>
								<td><h1 class="jumbotron">Пакетная проверка даты фида</h1></td>
							</tr>
							<tr>
								<td><img src="http://xtoolza.info/q/images/metrika.png" width="80" alt="Пакетная проверка даты фида"></td>
							</tr>
						</tbody>
					</table>
				</td>
