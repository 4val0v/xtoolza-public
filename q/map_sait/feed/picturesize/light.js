function check_context() {
 ...
 if ($("#site_list").attr("value") == "")
    ...
    $("#context").fadeOut(function() {
        ...
        $("#show_context").html("<span>Размер изображения по требованиям Google должен быть не больше <span style='color:red'>4МБ (4194304 байт)</span></span><br /><tr bgcolor='#00FA9A' id='one'><td>URL изображения</td><td>Размер изображения (byte)</td></tr>");
