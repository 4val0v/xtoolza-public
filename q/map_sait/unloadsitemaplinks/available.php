...
<html>
<head>
	<title>Проверить значения offer available</title>
	<meta name="description" content="Проверить значения offer available" />
    <meta charset="utf-8" />
			...
			<tr>
				...
				<td>
					<table>
						<tbody>
							<tr>
								<td><h1 class="jumbotron">Проверить значения offer available</h1></td>
							</tr>
							<tr>
								<td><img src="http://xtoolza.info/q/images/url.png" width="80" alt="Проверить значения offer available"></td>
							</tr> 
						</tbody>
					</table>
				</td>
...
<br />
<form action="/q/map_sait/feed/checkavailable.php" method="get">
<input type="text" name="site" value="Введите адрес xml" onclick='if(this.value=="Введите адрес xml") this.value=""' onBlur='if(this.value=="") this.value="Введите адрес xml"'><br><br>
...
<p>Инструмент, позволяющий произвести проверку значений offer available.</p>
<a href="http://xtoolza.info/q/map_sait/unloadsitemaplinks/tags.php">Выгрузить содержимое произвольных тегов из xml</a>
</div><br>
<br>
<br>
<table>
