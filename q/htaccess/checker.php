...
function filesBK() {
	echo '<details><summary><span style="cursor: pointer;"><b>BackUPs</b></summary>';
...
$cms = array(
                ...
                "Blogger" => array("meta content='blogger' name='generator'","rel='stylesheet' href='https://www.blogger.com/static/","window['blogger_blog_id'] = ","<meta content='http://www.blogger.com/profile/"),	
				...
				"Boxcode CMS" => array('Архив CMS находится на сайте www.boxcode.ru','box_mini_panel_manager','box_panel_light_auth_user','box_user_geo','box_panel_user'),
                ...
                "Surix-CMS" => array('Сайт работает на <a href="http://surix-cms.ru','target="_blank">Surix-CMS'),	
...
function diffinfo(){
	echo '<details><summary><span style="cursor: pointer;"><b>NS-info, file rights</b></summary>';
