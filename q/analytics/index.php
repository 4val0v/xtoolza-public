...
<html>
<head>
	<title>Пакетная проверка наличия Google Analytics на сайтах</title>
	<meta name="description" content="Пакетная проверка наличия Google Analytics на сайтах" />
	<meta name="keywords" content="Пакетная проверка наличия Google Analytics на сайтах">
			...
			<tr>
				...
				<td>
					<table>
						<tbody>
							<tr>
								<td><h1 class="jumbotron">Пакетная проверка наличия Google Analytics на сайтах</h1></td>
							</tr>
							<tr>
								<td><img src="http://xtoolza.info/q/images/analytics.png" width="80" alt="Пакетная проверка наличия Google Analytics на сайтах"> </td>
							</tr>
						</tbody>
					</table>
				</td>
...
<div><a href="logs/analytics.txt" download>логи скачать</a></div>
<br>
<a class="btn-success btn" href="http://xtoolza.info" rel="nofollow">На главную</a><br><br>
<div style="width: 750px font-size:14px;">Данный инструмент позволяет проверить список страниц на наличие на них счетчиков Google Analytics
</div><br>
