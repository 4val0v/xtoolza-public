...
<html>
<head>
	<title>Пакетная проверка наличия Яндекс.Метрики на сайтах</title>
	<meta name="description" content="Пакетная проверка наличия Яндекс.Метрики на сайтах" />
	<meta name="keywords" content="Пакетная проверка наличия Яндекс.Метрики на сайтах">
			...
			<tr>
				...
				<td>
					<table>
						<tbody>
							<tr>
								<td><h1 class="jumbotron">Пакетная проверка наличия Яндекс.Метрики на сайтах</h1></td>
							</tr>
							<tr>
								<td><img src="http://xtoolza.info/q/images/metrika.png" width="80" alt="Пакетная проверка наличия Яндекс.Метрики на сайтах"> </td>
							</tr>
						</tbody>
					</table>
				</td>
...
<div style="width: 750px font-size:14px;">Данный инструмент позволяет проверить список страниц на наличие на них счетчиков Яндекс.Метрики
</div><br>
