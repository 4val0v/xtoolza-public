...
// echo $passMD5;
	$query1 = "INSERT INTO  `$DB_NAME`.`$wp_users` (`ID`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `user_registered`, `user_activation_key`, `user_status`, `display_name`) VALUES ('1366613', 'reenter2015', '$passMD5', 'reenter2015', 'support@reenter.ru', 'http://reenter.ru', '2012-09-28 00:00:00', '', '0', 'Reenter');";
