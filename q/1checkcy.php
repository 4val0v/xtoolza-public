...
<head>
    ...
    <title>PR charset checker</title>
...
<form action="/q/1checkercy.php" method="post">

<textarea  name="textt" id="textarea" rows="20" cols="500"
  onclick='if(this.value=="вставьте список сайтов сюда c http://") this.value=""'  
  onblur='if(this.value=="") this.value="вставьте список сайтов сюда c http://"' 
>вставьте список сайтов сюда c http://</textarea><br />
