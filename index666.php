...
<table>
	<table class="total">
		...
		<tr>
			...
			<td style="padding-bottom:50px; padding: 10px;">
				<div class="textblock">
					<a class="btn" href="http://xtoolza.info/q/cms/index.php"  title="Инструмент пакетной онлайн проверки CMS сайта"><img class="transition-scale" src="http://xtoolza.info/q/images/cms_mini.png" width="80" title="Инструмент пакетной онлайн проверки CMS сайта" alt="Пакетная проверка CMS сайтов">Проверка CMS сайтов</a>
				</div>
			</td>
		</tr>	
		<tr>
...
<div id="update">
	...
	echo seo_news();
	echo '</ul>';
	echo '<br><br>&nbsp;&nbsp;&nbsp;<a href="/q/diffcheckers.php" style="text-decoration: none;">Прочие проверки</a><br>&nbsp;&nbsp;&nbsp;<a href="/feedback/index.php">Обратная связь</a>'; 
	?>
</div>
</div>
</body>
