...
<table cellpadding="1" cellspacing="-10">
	<tr>
		<td style="padding-bottom:50px padding: 15px;>
			<div class="textblock">
				<a href="http://xtoolza.info/go.php?url=http://uptimus.ru" title="Понятное и результативное продвижение сайта" target="_blank"><img class="transition-scale" src="http://xtoolza.info/q/images/Upti_mini.png" width="80" title="Понятное и результативное продвижение сайта" alt="Uptimus, продвижение сайта, купить рекламу"></a>
				<a href="http://xtoolza.info/go.php?url=http://uptimus.ru" title="Понятное и результативное продвижение сайта" target="_blank">Продвинуть сайт</a><br><br>
			</div>
		</td>
		<td style="padding-bottom:50px padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/checkencode.php" title="Пакетная проверка серверной и кодировки по мета-тегу"><img class="transition-scale" src="http://xtoolza.info/q/images/charset_mini.png" width="80" title="Пакетная проверка серверной и кодировки по мета-тегу" alt="Проверить кодировку">Проверить кодировку</a><br><br>
			</div>
		</td>
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/map_sait/sitemap_create.php" title="Создать карту сайта sitemap.xml онлайн"><img class="transition-scale" src="http://xtoolza.info/q/images/sitemapcreate_mini.png" width="80" title="Создать карту сайта sitemap.xml онлайн" alt="Создать карту сайта">Создать карту сайта</a><br><br>
			</div>
		</td>
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/checkip.php" title="Инструмент проверки трасировки, пинга, whois и многого другово."><img class="transition-scale" src="http://xtoolza.info/q/images/TCPIP_mini.png" width="80" title="Инструмент проверки трасировки, пинга, whois и многого другого." alt="Инструмент сетевых запросов">Инструмент сетевых запросов</a><br>
			</div>
		</td>
	</tr>	
	<tr>
		...
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/cms/index.php"  title="Инструмент пакетной онлайн проверки CMS сайта"><img class="transition-scale" src="http://xtoolza.info/q/images/cms_mini.png" width="80" title="Инструмент пакетной онлайн проверки CMS сайта" alt="Пакетная проверка CMS сайтов">Пакетная проверка CMS сайтов</a><br>
			</div>
		</td>
	</tr>	
	<tr>
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/checktdk.php" title="Пакетная выгрузка мета-тегов title, description, keywords с указанных страниц"><img class="transition-scale" src="http://xtoolza.info/q/images/tdk_mini.jpg" width="80" title="Пакетная выгрузка мета-тегов title, description, keywords с указанных страниц" alt="Выгрузить meta-теги"><br>Выгрузить meta-теги</a><br><br><br>
			</div>
		</td>
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/check404.php" title="Пакетная проверка отработки 404 статус-кода на сайтах"><img class="transition-scale" src="http://xtoolza.info/q/images/404_mini.png" width="80" title="Пакетная проверка отработки 404 статус-кода на сайтах" alt="404 статус-код"><br>Проверить 404 статус-код</a><br><br><br>
			</div>
		</td>
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/broken/index.php" title="Инструмент поиска внешних и битых ссылок сайта"><img class="transition-scale" src="http://xtoolza.info/q/images/links_mini.jpg" width="80" title="Инструмент поиска внешних и битых ссылок сайта" alt="внешние ссылки, битые ссылки">Поиск внешних и битых ссылок</a><br><br>
			</div>
		</td>
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/checkphp.php" title="Пакетная проверка сайтов на наличие PHP онлайн"><img class="transition-scale" src="http://xtoolza.info/q/images/php_mini.png" width="80" title="Пакетная проверка сайтов на наличие PHP онлайн" alt="Проверка на PHP">Пакетная проверка сайтов на PHP</a><br><br>
			</div>
		</td>
	</tr>	
	<tr>
		...
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/fav/favicon.php" title="Пакетная выгрузка пиктограмм (Favicon) сайтов"><img class="transition-scale" src="http://xtoolza.info/q/images/favicon_mini.jpg" width="80" title="Пакетная выгрузка пиктограмм (Favicon) сайтов" alt="выгрузить Favicon с сайта">Пакетная выгрузка Favicon</a>
			</div>
		</td>
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/checklinks.php" title="Инструмент пакетной выгрузки всех ссылок со страниц"><img class="transition-scale" src="http://xtoolza.info/q/images/url_mini.png" width="80" title="Инструмент пакетной выгрузки всех ссылок со страниц" alt="Выгрузить ссылки">Выгрузить ссылки со страницы</a>
			</div>
		</td>
		<td style="padding-bottom:50px; padding: 15px;>
			<div class="textblock">
				<a class="btn" href="http://xtoolza.info/q/puny/punycode_converter.php" title="Инструмент конвертирования кириллических доменов в punycode и обратно"><img class="transition-scale" src="http://xtoolza.info/q/images/punicode_mini.png" width="80" title="Инструмент конвертирования кириллических доменов в punycode и обратно" alt="Конвертировать в punycode online">Punycode конвертер</a><br><br>
			</div>
		</td>
	</tr>	
...
<div id="footer">
   ...
   <a href="/q/checkpogoda.php" rel="nofollow" style="text-decoration: none;">©</a> 2014 xtoolza.info<br />
   <a href="/whatnew.php" rel="nofollow">release note</a>&nbsp;&nbsp;&nbsp;<a href="/feedback/index.php">Обратная связь</a><br />
</div>
...
if(preg_match_all("/[\d-\.]+/", $cont, $arr, PREG_PATTERN_ORDER)) {
		echo '<ul><li>1$ = '.$arr[0][0].' р.</li>';
		echo '<li>1&#128; = '.$arr[0][1].' р.</li>';
		echo '<li>1 барр. = '.$arr[0][2].' $.</li></ul>';
}
else return null;
?>
</div>
