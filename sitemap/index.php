			...
			<td>
				<table>
					<tbody>
						...
						<tr>
							<td><img src="http://xtoolza.info/q/images/sitemapcreate.png" width="80" alt="создать карту сайта"> </td>
						</tr>
					</tbody>
				</table>
			</td>
...
$engine_root=$_SERVER['DOCUMENT_ROOT'].'/sitemap/';
...
foreach($urls as $k => $v){
    $sitemapXML.="\r\n<url><loc>{$k}</loc><lastmod>$datetoday</lastmod><priority>1.00</priority><changefreq>weekly</changefreq></url>";
    $sitemapTXT.="\r\n".$k;
}
...
echo "<b>Найдено: " .count($urls)."</a> страниц</b>";

?>

<br /><h3><a href="http://xtoolza.info/sitemap/sitemap.xml" download>Скачать sitemap.xml &nbsp;<img src="http://xtoolza.info/q/images/arrow_curved_blue.png" width="70px"></a></h3>
<h5><a href="http://xtoolza.info/sitemap/sitemap.txt" download>Скачать список найденных страниц</a></h5><br />

<textarea rows="20" cols="500"><?php
$read = file_get_contents("http://xtoolza.info/sitemap/sitemap.xml");
