...
<div id="wrapper">
	<div id="header">
		<h1 class='jumbotron'>xToolza Proxy</h1><br><br>
		 <br><br>
	</div>
	<div id="content">
		<h2>Введите URL</h2>
		...
		<br><a class="btn-success btn" href="http://xtoolza.info">На главную</a>&nbsp;&nbsp;<a class="btn-success btn" href="http://xtoolza.info/proxy2/">Прокси 2</a>&nbsp;&nbsp;<a class="btn-success btn" href="http://xtoolza.info/proxy3/">Прокси 3</a>&nbsp;&nbsp;<br><br>
	</div><noindex>
	<div id="footer"><span style="visibility:hidden">
		Powered by <a href="http://www.glype.com/" rel="nofollow">Glype</a>&reg; <!--[version]-->.</span>
	</div></noindex>
</div>
<?php
